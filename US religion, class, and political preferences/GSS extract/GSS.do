...
label values eqwlth   gsp002x;
label values partyid  gsp003x;
label values ballot   gsp004x;
label values realinc  gsp005x;
label values fund     gsp006x;
label values denom    gsp007x;
label values relig    gsp008x;
label values race     gsp009x;
label values educ     gsp010x;
label values occ10    gsp011x;
label values union_   gsp012x;
